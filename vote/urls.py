...
urlpatterns = [
    ...
    path(
        "run_for_election/<str:username>",
        votes_views.run_for_election,
        name="run_for_election",
    ),
    path("homePage", votes_views.home_page, name="homePage"),
    path(
        "candidate/profile/<str:username>",
        votes_views.candidate_profile,
        name="candidate/profile",
    ),
    path("profile", users_views.profile, name="profile"),
    path(
        "voteCandidate/<str:username>", votes_views.vote_candidate, name="voteCandidate"
    ),
